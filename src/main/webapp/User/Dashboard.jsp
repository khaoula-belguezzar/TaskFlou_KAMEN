  ...
  <span class="user-img">
            ...
            <div class="dropdown-menu">
                <button type="submit" class="btn btn-link" style="margin-left: 0px">
                    <a href="UserHomeServlet?action=profileUser">
    ...
    <div class="sidebar-inner slimscroll">
        <div class="sidebar-contents">
            <div id="sidebar-menu" class="sidebar-menu">
                ...
                <ul>
                    <li class=""> <%-- active--%>
                        <a href="UserHomeServlet"><i style="color: #E0BE81" class="fa-solid fa-gauge-high"></i>
                   ...
                   <li  class="#">
                        <a href="UserHomeServlet?action=profileUser"><i  style="color: #E0BE81" class="fa-solid fa-id-badge"></i>
