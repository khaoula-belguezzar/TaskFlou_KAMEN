...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
                ...
                <div class="modal fade" id="deleteModal${commentaire.id}" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="GestionnerHomeServlet?action=deletecommentaire&id=<c:out value='${commentaire.id}' />" method="POST" enctype="multipart/form-data">
            ...
            <form action="GestionnerHomeServlet?action=addcommentaire" method="POST">
        ...
        <div class="col-md-6">
            ...
            <c:forEach items="${commentaires}" var="commentaire">
                <div class="comment-card" style="margin-top: 5%">
                    ...
                    <p class="comment-text" style="margin-top: 4%; margin-left: 2%;font-size: 18px ;color: #052659">
